...
<div class="mb-3"><label class="form-label">Class Name</label><input required name="name" class="form-control" type="text" placeholder="e.g. Grade 8 A"></div>
...
<div class="mb-3"><label class="form-label">Class Name</label><input id="name" required name="name" class="form-control" type="text" placeholder="Enter Class Name"></div>
...
<thead><tr><th>Name</th><th>Added On</th><th width="140"></th></tr></thead>
<tbody>
<?php
try {
	$conn = app_db();

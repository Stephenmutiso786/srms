...
app_require_permission('attendance.manage', '../admin');
    ...
    <table class="table table-hover table-striped">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><a class="btn btn-sm btn-outline-primary" href="admin/attendance_mark_session?id=<?php echo (int)$s['id']; ?>">Open</a></td>
        </tr>
        <?php } ?>
      </tbody>
    </table>

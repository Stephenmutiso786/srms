...
try {
  ...
  $stmt = $conn->prepare("UPDATE tbl_exam_mark_submissions SET status = 'approved', reviewed_at = CURRENT_TIMESTAMP, reviewed_by = ? WHERE id = ? AND status = 'submitted'");
  ...
  $_SESSION['reply'] = array (array("success", "Marks approved."));
} catch (Throwable $e) {

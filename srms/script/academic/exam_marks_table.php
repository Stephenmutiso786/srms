...
<div class="mb-2">
  <a class="btn btn-sm btn-outline-secondary" target="_blank" href="teacher/print_mark_sheet?exam_id=<?php echo (int)$examId; ?>&subject_combination=<?php echo (int)$subjectComb; ?>&assessment_type=<?php echo urlencode((string)($exam['name'] ?? 'Assessment')); ?>&origin_portal=academic"><i class="bi bi-printer me-1"></i>Print Mark Sheet</a>

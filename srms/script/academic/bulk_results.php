...
<a href="academic/save_pdf?std=<?php echo $row2[0]; ?>&term=<?php echo $term;?><?php echo $examId > 0 ? '&exam=' . $examId : ''; ?>&download=1" class="btn btn-primary btn-sm" href="javascript:void(0);">Report</a>

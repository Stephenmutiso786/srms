...
app_require_permission('attendance.manage', '../academic');
    ...
    <table class="table table-hover table-striped">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><a class="btn btn-sm btn-outline-primary" href="academic/attendance_session.php?id=<?php echo (int)$s['id']; ?>">Open</a></td>
        </tr>
        <?php } ?>
      </tbody>
    </table>

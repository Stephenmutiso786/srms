...
<?php endforeach; ?>
<?php if(!$rows): ?><tr><td colspan="5" class="text-center text-muted">No certificates available for your classes yet.</td></tr><?php endif; ?>

...
app_require_permission('staff.manage', 'teacher');
...
<head>
<title>Roles - <?php echo APP_NAME; ?></title>
<meta charset="utf-8">
...
<div>
<h1>Roles</h1>
<p>Assign operational and leadership roles to staff from the teachers module.</p>
</div>
<div>
...
<form class="app_frm" action="teacher/core/assign_role" method="POST">
<div class="mb-3">
<label class="form-label">Staff</label>
<select class="form-control" name="staff_id" required>
<option value="">Select</option>
<?php foreach ($staff as $s): ?>
<option value="<?php echo (int)$s['id']; ?>"><?php echo htmlspecialchars($s['name'].' (#'.$s['id'].') - '.app_staff_primary_title($conn, (int)$s['id'], (string)$s['level'])); ?></option>
<?php endforeach; ?>
</select>
</div>
<div class="mb-3">
...
<option value="<?php echo (int)$r['id']; ?>"><?php echo htmlspecialchars($r['name'].' - '.$r['description']); ?></option>
<?php endforeach; ?>
</select>
</div>

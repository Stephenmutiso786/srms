...
<li><a class="app-menu__item active" href="accountant/invoices"><i class="app-menu__icon feather icon-file-text"></i><span class="app-menu__label">Invoices</span></a></li>
</ul>
</aside>
...
<div class="tile mb-3">
  ...
  <form class="row g-3" method="GET" action="accountant/invoices">
	<div class="col-md-5">
...
<div class="tile mb-3">
  ...
  <p class="text-muted mb-2">Cash-only collection mode for accountability and fast reconciliation.</p>

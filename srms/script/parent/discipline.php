...
try {
	...
	$stmt = $conn->prepare("SELECT d.id, d.incident_type, d.description, d.severity, d.status, d.created_at,
		...
		JOIN tbl_parent_students ps ON ps.student_id = d.student_id
...
<html lang="en">
<head>
<title><?php echo APP_NAME; ?> - Parent Discipline</title>
<meta charset="utf-8">
...
<thead><tr><th>Date</th><th>Student</th><th>Class</th><th>Type</th><th>Severity</th><th>Status</th><th>Description</th></tr></thead>
<tbody>
...
<?php endforeach; ?>
<?php if (!$cases): ?><tr><td colspan="7" class="text-center text-muted">No discipline cases found yet.</td></tr><?php endif; ?>
</tbody>
</table>
</div>
</div>

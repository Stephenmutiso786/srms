...
(1, 'ELIMU HUB', 'school_logo.png', 1, 1);
...
(3, 'ABDUL', 'SHABAN', 'Male', 'abdul@example.edu', '$2y$10$l8XYJDrBHTyeZkpupiRhwey6jJihzku0bYXiVtBM5kDRz3sZvSpgC', 2, 1),
(4, 'COLLINS', 'MPAGAMA', 'Male', 'collins@example.edu', '$2y$10$l8XYJDrBHTyeZkpupiRhwey6jJihzku0bYXiVtBM5kDRz3sZvSpgC', 2, 1),
(5, 'DAVID', 'OMAO', 'Male', 'david@example.edu', '$2y$10$l8XYJDrBHTyeZkpupiRhwey6jJihzku0bYXiVtBM5kDRz3sZvSpgC', 2, 1),
(6, 'DENIS', 'MWAMBUNGU', 'Male', 'denis@example.edu', '$2y$10$l8XYJDrBHTyeZkpupiRhwey6jJihzku0bYXiVtBM5kDRz3sZvSpgC', 2, 1),
(7, 'ERICK', 'LUOGA', 'Male', 'erick@example.edu', '$2y$10$l8XYJDrBHTyeZkpupiRhwey6jJihzku0bYXiVtBM5kDRz3sZvSpgC', 2, 1),
(8, 'FARAJI', 'FARAJI', 'Male', 'faraji@example.edu', '$2y$10$l8XYJDrBHTyeZkpupiRhwey6jJihzku0bYXiVtBM5kDRz3sZvSpgC', 2, 1),
(9, 'FATMA', 'BAHADAD', 'Female', 'fatma@example.edu', '$2y$10$l8XYJDrBHTyeZkpupiRhwey6jJihzku0bYXiVtBM5kDRz3sZvSpgC', 2, 1),
(10, 'FRANCIS', 'MASANJA', 'Male', 'francis@example.edu', '$2y$10$l8XYJDrBHTyeZkpupiRhwey6jJihzku0bYXiVtBM5kDRz3sZvSpgC', 2, 1),
(11, 'GLADNESS ', 'PHILIPO', 'Female', 'gladness@example.edu', '$2y$10$l8XYJDrBHTyeZkpupiRhwey6jJihzku0bYXiVtBM5kDRz3sZvSpgC', 2, 1),
(12, 'GRATION', 'GRATION', 'Male', 'gration@example.edu', '$2y$10$l8XYJDrBHTyeZkpupiRhwey6jJihzku0bYXiVtBM5kDRz3sZvSpgC', 2, 1),
(13, 'HANS', 'UISSO', 'Male', 'hans@example.edu', '$2y$10$l8XYJDrBHTyeZkpupiRhwey6jJihzku0bYXiVtBM5kDRz3sZvSpgC', 2, 1),
(14, 'HANSON', 'MAITA', 'Male', 'hanson@example.edu', '$2y$10$l8XYJDrBHTyeZkpupiRhwey6jJihzku0bYXiVtBM5kDRz3sZvSpgC', 2, 1),
(15, 'HENRY', 'GOWELLE', 'Male', 'henry@example.edu', '$2y$10$l8XYJDrBHTyeZkpupiRhwey6jJihzku0bYXiVtBM5kDRz3sZvSpgC', 2, 1),
(16, 'HILDA', 'KANDAUMA', 'Female', 'hilda@example.edu', '$2y$10$l8XYJDrBHTyeZkpupiRhwey6jJihzku0bYXiVtBM5kDRz3sZvSpgC', 2, 1),
(17, 'INNOCENT', 'MBAWALA', 'Male', 'innocent@example.edu', '$2y$10$l8XYJDrBHTyeZkpupiRhwey6jJihzku0bYXiVtBM5kDRz3sZvSpgC', 2, 1),
(18, 'JAMALI', 'NZOTA', 'Male', 'jamali@example.edu', '$2y$10$l8XYJDrBHTyeZkpupiRhwey6jJihzku0bYXiVtBM5kDRz3sZvSpgC', 2, 1),
(19, 'JAMIL', 'ABDALLAH', 'Male', 'jamil@example.edu', '$2y$10$l8XYJDrBHTyeZkpupiRhwey6jJihzku0bYXiVtBM5kDRz3sZvSpgC', 2, 1),
(20, 'JOAN', 'NKYA', 'Female', 'joan@example.edu', '$2y$10$l8XYJDrBHTyeZkpupiRhwey6jJihzku0bYXiVtBM5kDRz3sZvSpgC', 2, 1),
(21, 'JOSEPH', 'HAMISI', 'Male', 'joseph@example.edu', '$2y$10$l8XYJDrBHTyeZkpupiRhwey6jJihzku0bYXiVtBM5kDRz3sZvSpgC', 2, 1),
...
('RG001', 'OSWARD', 'JORAM', 'SEBATWALE', 'Male', 'oswardj@example.edu', 3, '$2y$10$XIE1yTXiRYWKrW7.e.OjGeYy.B9guq/sLh9rqu47YO1/QR1ZX93VW', 3, 'avator_1710936891.jpg', 1),
('RG002', 'PAULO', 'W', 'MOSHI', 'Male', 'paulow@example.edu', 3, '$2y$10$RN3P.rFnGYY2eZaLR6wOge8yJByl1Fjm3TbzCU0S/ZVBconH0fNo.', 3, 'avator_1710936905.jpg', 1),
('RG003', 'REHEMA', 'JAMES', 'MUSSA', 'Female', 'rehemaj@example.edu', 3, '$2y$10$sVdbGNtV2rUa6JvQE6xCOOtvXTxboEYRu7DZ4p/Iw7n3AZiJS/3Ly', 3, 'avator_1710936914.jpg', 1),
('RG004', 'TUMSIFU', 'ALFRED', 'KAMALA', 'Female', 'tumsifua@example.edu', 3, '$2y$10$fyfsYVo8oNrziA9QN9iMHuc5A8M8IGe6o/LSmmUmbBeNnhxNVIRl2', 3, 'avator_1710936926.jpg', 1),
('RG005', 'YUSTINO', 'EZRAEL', 'MBIGO', 'Male', 'yustinoe@example.edu', 3, '$2y$10$PtjCClDQa/ZbyB3fVeVUee2Z7PjEuTt8.haBL0um8qbuqHzwml0MS', 3, 'avator_1710936946.jpg', 1),
('RG006', 'ALICE', 'M', 'MUGISHA', 'Female', 'alice@example.edu', 4, '$2y$10$B1TJ31juU36kicOs2ULaw.tTTWmtcqhgJ2orYxHmjvM7pSfCWJr5C', 3, 'avator_1710936962.jpg', 1),
...
('RG012', 'QUEEN ', 'JULIUS', 'BENJAMIN', 'Female', 'queen@example.edu', 5, '$2y$10$1BtsttroEwKx8Bs4Y.I36uTKJBopsjOStAco3l0JJbD3yoU.Zvs1y', 3, 'DEFAULT', 1),
('RG013', 'RAJABU', 'M', 'MILANZI', 'Male', 'rajabu@example.edu', 5, '$2y$10$jvfxswqLon3PcZvepUM7lOBTCZFShQidjysPvSo.6l/d.5.N2tpDC', 3, 'DEFAULT', 1),
('RG014', 'REHEMA', 'SILIVESTER', 'LEMABI', 'Female', 'rehema@example.edu', 5, '$2y$10$g7aNMemiSOf6j10Z9kGrEuM79Wx3j8Rs22d5bap5rnHvTtD/VRdp.', 3, 'DEFAULT', 1),
('RG015', 'SHAIBU', 'RASHIDI', 'MPONDA', 'Male', 'shaibu@example.edu', 5, '$2y$10$Ic.FhKjvB3dJJtiT0iUbHuRSr.i8qGEZQnDYNCdxEiybaWUjWtP5K', 3, 'DEFAULT', 1),
('RG016', 'UMMUKULTHUM ', 'BAKARI', 'PANGO', 'Female', 'ummukulthum@example.edu', 5, '$2y$10$PdFlObFsViSTLs.yJuxFWus7uF0.TUC16kbaVJGIBwFUbMVkDgTgC', 3, 'DEFAULT', 1),
('RG017', 'ANDREW', 'ISAAC', 'MABIKI', 'Male', 'andrew@example.edu', 6, '$2y$10$7aswGGxLgfkUbfYH/fwj/.WyFnm946Lxk90z9MIG7ZCLWi/k5bZ3.', 3, 'DEFAULT', 1),
('RG018', 'BRYSON', 'KHAMIS', 'MKHANY', 'Male', 'bryson@example.edu', 6, '$2y$10$XxHNLF6LUkq./WsMPKYP/emqMkIQ1aaH9GM/.967RgMpZzLi0a8Gy', 3, 'DEFAULT', 1),
('RG019', 'EMMNAUEL', 'EMMNAUEL', 'JOSEPH', 'Male', 'emmnauel@example.edu', 6, '$2y$10$t35jhCZhHAgJsDobC9gNFuOWvGc9xUPFrVTUBRc1.JT2nVWNzXCni', 3, 'DEFAULT', 1),
('RG020', 'FRANCO', 'FRANCO', 'MLAWA', 'Male', 'franco@example.edu', 6, '$2y$10$pqUi6rYnotgMLODlNRlSpu8rxUTJ.mtfcjUNVq/7mA5037uLFe5zO', 3, 'DEFAULT', 1),
('RG021', 'MICHAEL', 'GABRIEL', 'NDEKWA', 'Male', 'michael@example.edu', 6, '$2y$10$qsHSbSbQGceU8VGKlxptu.1GfwPCH9yoX7c1lKh5qdPGruIua9fTC', 3, 'DEFAULT', 1),
('RG022', 'NYEMO', 'WILFRED', 'SENHYINA', 'Male', 'nyemo@example.edu', 6, '$2y$10$rOhIasvPU8RW0WMqtVXxHOiLW2J66wpbE5NUd0lJBA9GbFb7nAogy', 3, 'DEFAULT', 1),
('RG023', 'RAMADHANI', 'JUMA', 'KIFUNTA', 'Male', 'ramadhani@example.edu', 6, '$2y$10$r81yFW5othiG5iGkKTh6GOOhmrSbhYG.B/Lhv3.hjH6hZ5tYV8E2m', 3, 'DEFAULT', 1),
('RG024', 'SAIDA', 'ABDULQADIR', 'MOHAMED', 'Female', 'saida@example.edu', 6, '$2y$10$Z3U9EU.ywJbQAjgtN2A5FO2Asw3qezCYhA7W6qvue4ehi2ePLeQQG', 3, 'DEFAULT', 1),
('RG025', 'SALMA', 'FADHIL', 'MGANGA', 'Female', 'salma@example.edu', 6, '$2y$10$IQjuYGKYXPlzgNwxow0Zd.0bZrbAZZ5ArEAUTCavfvBKPymGOOh7W', 3, 'DEFAULT', 1),
('RG026', 'LUCAS', 'J', 'MAIVAJI', 'Male', 'lucas@example.edu', 7, '$2y$10$yYIzQ6RtyI4xLzpAIBSg.uiJuAg6.T5jmvDQVytB2JPIUlwMtq7bi', 3, 'DEFAULT', 1),
('RG027', 'Mbarouk', 'Abdi', 'MBAROUK', 'Male', 'mbarouk@example.edu', 7, '$2y$10$UIcz5q8wbyCYnOFMSODjO.18PCG75DzY8yZDvtx2N4qqWMDLHdyna', 3, 'DEFAULT', 1),
('RG029', 'NATHAN', 'JORAM', 'MAHUNDI', 'Male', 'nathan@example.edu', 7, '$2y$10$fmyCT5/rEONcZZ7VwSvsqexW6sTMtaNU0/.UuseUxvMlUYb5bum9a', 3, 'DEFAULT', 1),
('RG030', 'PATRICK', 'STEVEN', 'MAPUNDA', 'Male', 'patrick@example.edu', 7, '$2y$10$mH3xVRY89bog.AXxBkZ.KedfwplTlmZzctwlMs2EfXcYQvZrGKIaO', 3, 'DEFAULT', 1),
('RG031', 'PHILIPO', 'A', 'KANYOKI', 'Male', 'philipo@example.edu', 7, '$2y$10$4QwWL4bPU.UBW7AkXIv7FO73zZBGkjpTWwOzEDaOU/dpqvXHyUgOC', 3, 'DEFAULT', 1),
('RG033', 'SADICK', 'SHARABII', 'KIBASA', 'Male', 'sadick@example.edu', 7, '$2y$10$bo3kC2paitvInM.7bmkNVeOsNJq2vDNzgQBunzh3pKtx2r389s0xS', 3, 'DEFAULT', 1),
('RG034', 'STEVEN', 'DAUD', 'DAUDI', 'Male', 'steven@example.edu', 7, '$2y$10$KoiNZztpY89BKf9eceJBJ.D3UEQ4Snd3DC67aIlhEG4H9lQFvGLKK', 3, 'DEFAULT', 1),
('RG035', 'TITUS', 'S', 'SIZIMWE', 'Male', 'titus@example.edu', 8, '$2y$10$1XfiDBvDZfDm9VWU9GtNmeO6H4nhPnhMBetS6zlxdi4E6ugm66HC6', 3, 'DEFAULT', 1),
('RG036', 'TUMAINIEL', 'JONA', 'MKONY', 'Male', 'tumainiel@example.edu', 8, '$2y$10$/312a8OcyO14EDLWmIA1vODEAwEMHdgyZ7R/3dx0CWSnQ0ijz6bkm', 3, 'DEFAULT', 1),
('RG037', 'Willfat', 'Hassan', 'SHAMS', 'Female', 'willfat@example.edu', 8, '$2y$10$WKDBlVj/lsuLqezdINtqQuxpRwgr8kZxof/tJjC6hgv06yE/58l46', 3, 'DEFAULT', 1),
('RG038', 'WILLIAM', 'MUJUNI', 'BALAILE', 'Male', 'william@example.edu', 8, '$2y$10$h30odqjWbQSkI3IKEDoR/u1EoBvYzzeoYl7LIgoPHD.jbpj4pyr62', 3, 'DEFAULT', 1),
('RG039', 'YOHANA', 'JACKSON', 'SIIMA', 'Male', 'yohana@example.edu', 8, '$2y$10$FLqe1Tf/71wHH51KbHqb1e5uqou4uzxKYfe.yhORo30kgK.2QXRlO', 3, 'DEFAULT', 1);

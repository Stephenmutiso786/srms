...
CREATE INDEX IF NOT EXISTS tbl_cbe_assessments_student_idx ON tbl_cbe_assessments (student_id);
CREATE INDEX IF NOT EXISTS tbl_cbe_assessments_term_idx ON tbl_cbe_assessments (term_id);
